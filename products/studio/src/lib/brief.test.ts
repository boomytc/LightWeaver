...
describe("buildAgentBrief", () => {
  it("stitches voice, kit, recipe, and output home into a copyable agent note", () => {
    ...
    assert.match(text, /data\/first-party\/study-explainer\/taxonomy-parade\/dropdown-taxonomy\/assets\/outputs/);
  ...
  it("names a user-film output dir and does not invent an outside copy", () => {
    ...
    assert.match(text, /data\/projects\/<task>\/<recipe>\/<id>\/assets\/outputs/);
  ...
  it("maps first-party home to data/first-party without an outside project", () => {
    assert.equal(
      instanceDir("first-party", "nav-taxonomy", "study-explainer", "taxonomy-parade"),
    ...
    assert.match(text, /data\/first-party\/<task>\/<recipe>\/<id>\/assets\/outputs/);
  ...
  it("tells footage-narration to register source video and skip Remotion", () => {
    ...
    assert.match(text, /data\/projects\/footage-narration\/<recipe>\/<id>\/assets\/outputs/);
